								   ...
								   <!-- Tab panes -->
									<div class="tab-content">
									 <div role="tabpanel" class="tab-pane active" id="hotels">
									 	<form action="<?php echo U('Home/index/user');?>" method="post">
									 	<div class="row">
											<div class="col-xxs-12 col-xs-12 mt">
												<div class="input-field">
													<label for="from">用户名</label>
													<input type="text" class="form-control" name="username" id="from-place" value="<?php echo ($list["username"]); ?>" readonly="on" />
												</div>
											</div>
											<!-- <div class="col-xxs-12 col-xs-6 mt alternate">
												<div class="input-field">
													<label for="date-start">上一次骑行日期</label>
													<input type="text" class="form-control" id="date-start" value="<?php echo (date('Y-m-d',$list["borrow_time"])); ?>" readonly="on" />
												</div>
											</div>
											<div class="col-xxs-12 col-xs-6 mt alternate">
												<div class="input-field">
													<label for="date-end">今天的日期</label>
													<input type="text" class="form-control" id="date-end" value="<?php echo (date('Y-m-d',$now)); ?>" readonly="on" />
												</div>
											</div> -->
											<!-- <span style="color: #000;margin-left: 1em">单车召回管理</span> -->
											<div class="col-sm-12 mt">
												<!-- <section>
													<label for="class">零部件损毁提交</label>
													<select class="cs-select cs-skin-border" name="cogs">
														<option value="">无</option>
														<option value="1">车链</option>
														<option value="2">车锁</option>
														<option value="3">刹车</option>
														<option value="4">夜灯</option>
														<option value="5">车筐</option>
														<option value="6">轮胎</option>
													</select>
												</section> -->
											</div>
											<!-- <div class="checkbox1">
												
												<input type="checkbox" value="车锁">处于禁停区域
												<input type="checkbox" value="刹车">损坏严重
												
											</div>
											<br>

											<textarea name="" id="" cols="34" rows="5" style="margin-left: 1em;color: #000" placeholder="请对单车召回原因添加描述" ></textarea> -->
											<!-- <div class="col-xs-12">
												<button class="btn btn-primary btn-block">还车</button>
												<input type="submit" class="btn btn-primary btn-block" value="提交">
											</div> -->

											<div class="col-sm-12 mt">
												<section>
													<label for="class">用户申报管理</label>
													<select class="cs-select cs-skin-border" name="cogs">
														<option value="">请下拉进行选择</option>
														<option value="1">单车报修管理</option>
														<option value="2">单车召回管理</option>
											...
											<div class="col-sm-12 mt">
												<section>
													<label for="class">电子区域设置管理</label>
													<select class="cs-select cs-skin-border" name="cogs">
														<option value="">请下拉进行选择</option>
														<option value="1">禁停区域管理</option>
														<option value="2">电子围栏管理</option>
											...
											<div class="col-sm-12 mt">
												<section>
													<label for="class">单车智能化管理</label>
													<select class="cs-select cs-skin-border" name="cogs">
														<option value="">请下拉进行选择</option>
														<option value="1">夜间照明功能</option>
														<option value="2">过载检测功能</option>
													</select>
												</section>
											</div>

											<!-- <div class="col-xs-12">
												<button class="btn btn-primary btn-block">单车召回</button>
												
											</div> -->

											<div class="col-xs-12">
												<button class="btn btn-primary btn-block">还车</button>
												<!-- <input type="submit" class="btn btn-primary btn-block" value="还车"> -->
											</div>
											<input type="hidden" name="bike_id" value="<?php echo ($list["bike_id"]); ?>">
...
<!-- 											<div class="col-xxs-12 col-xs-6 mt">
											...
											<table class="table" style="color: #000000">
												...
												<tbody>
													<?php if(is_array($borrow)): $i = 0; $__LIST__ = $borrow;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
														...
														<td><?php echo ($vo["borrow_position"]); ?></td>
														<!-- <td><?php echo (date('Y-m-d',$vo["borrow_time"])); ?></td> -->
											...
											<div class="col-xs-12">
												<input type="submit" class="btn btn-primary btn-block" value="更新数据">
											</div>
										</div>
									 </div>
									</div>
